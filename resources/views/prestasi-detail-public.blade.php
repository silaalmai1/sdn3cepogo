        ...
        <div class="container">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-7">
                    ...
                    <h1 class="fw-bold mb-4" style="font-size: 32px; line-height: 1.3;">{{ $prestasi->judul }}</h1>
                    <div class="detail-text" style="font-size: 16px; line-height: 1.8; text-align: justify;">
