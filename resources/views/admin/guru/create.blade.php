    ...
    <div class="card p-4">
        ...
        <form action="/admin/guru/store" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <div
                    class="border rounded p-2 text-center bg-light guru-preview-wrap d-flex align-items-center justify-content-center flex-column">
                    <img id="guru-foto-preview" src="" alt="Preview Foto Guru" class="img-fluid rounded"
                        style="display: none;">
                    <p id="guru-foto-empty" class="text-muted mb-0">Belum ada foto dipilih</p>
                </div>
            </div>
