                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card prestasi-card h-100 shadow-sm">
                            ...
                            <div class="card-body d-flex flex-column">
                                ...
                                <h5 class="card-title fw-bold" style="font-size: 18px; line-height: 1.4;">
                                    {{ $prestasi->judul }}</h5>
                                <p class="text-muted mb-3" style="font-size: 13px;">
                                    <i class="bi bi-calendar-event"></i> Tahun {{ $prestasi->tahun }}
                                </p>
                                <p class="card-text flex-grow-1" style="font-size: 14px; line-height: 1.6;">
                                    {{ Str::limit($prestasi->deskripsi_lengkap, 120) }}
                                </p>
                                <a href="/prestasi/{{ $prestasi->slug }}" class="btn-baca-selengkapnya mt-auto">
